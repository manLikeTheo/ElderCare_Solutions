    ...
    <div className="">
      ...
      <div className=" bg-stone-100 px-10 py-14 mx-auto flex flex-col">
        <div className="changing-the-narrative  grid grid-cols-1 md:grid-cols-2   items-center gap-12 p-3 border-b-4 border-stone-300">
          <div className="text">
            ...
            <p className=" text-xl font-medium">
              <span className="font-bold">WellAged Care</span> is a
              senior-focused social enterprise dedicated to transforming the way
              we care for seniors. Our platform connects families—both within
              Nigeria and across the globe—with local, compassionate caregivers,
              offering comprehensive, accessible, and affordable solutions to
              elder care. We are addressing the overlooked gaps in senior care,
              where clinical needs often take precedence over connection,
              ...
              technology and our Elderly Care Kit, WellAged Care is reshaping
              the elder care landscape in Nigeria and Africa.
        ...
        <div className="your-story mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 justify-between items-center gap-12 *:py-3 border-b-4 py-4">
          <div className="">
            ...
            <p className="tracking-wider text-xl font-medium">
              {" "}
              <b>WellAged Care</b> was created after recognizing the deep flaws
              in the current senior care system. As many families—especially
        ...
        <div className="broken-system mt-8 mb-4 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-6 border-b-4">
          <div className="text">
            ...
            <p className="text-xl lg:text-xl">
              ...
              with guilt and worry. At WellAged Care, we aim to change all of
              this— bycreating a solution that connects families directly to
              trusted local care and support workers and offering a range of
              tools to ensure independence, safety, and emotional well-being for
              seniors, no matter where their family members are.
            </p>
          </div>
          <div className="image  ">
            <Image
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center place-items-center py-6 mt-6  border-b-4">
          <div className="text grid grid-cols-1 lg:grid-cols-2 items-baseline justify-center gap-1">
            <h2 className="text-4xl font-extrabold py-4">
              Flipping the Script: WellAged Care's Approach
            </h2>
            <p className=" text-xl">
              Rather than accepting the status quo, WellAged Care has flipped
              the traditional senior care model. We leverage technology to
              create a platform that not only connects families with
              compassionate, vetted caregivers but also provides seniors with
              the tools they need for self-sufficiency, safety, and social
              interaction. We believe senior care is about more than just
              meeting medical needs—it’s about empowering seniors to continue
              living with purpose, connected to their families, and engaged in
              their communities. AgeBuddy’s approach removes unnecessary
              middlemen, providing affordable care, empowered caregivers, and
              innovative solutions like our Elderly Care Kit to help seniors
        ...
        <div className="agebuddy-difference mt-10 py-6 *:pb-8 border-b-4 ">
          <div>
            ...
            <p className=" text-xl sm:text-2xl lg:text-xl leading-relaxed max-w-3xl">
              <b>For Families:</b> WellAged Care offers families an easy way to
              find trustworthy local caregivers, ensuring that seniors are
              receiving the best care—both physically and emotionally—while
              still staying connected with their loved ones through our digital
              communication tools.
            </p>
            ...
            <p className="sm:text-2xl lg:text-xl leading-relaxed max-w-3xl text-xl">
              <b>For Communities:</b> By focusing on holistic care, WellAged
              Care is investing in a future where seniors are valued and
              supported in all aspects of their lives, helping break down the
              barriers of isolation and neglect - that impacts their health and
        ...
        <div className="future-of-senior-care mt-10 py-6 border-b-4">
          ...
          <p className=" text-xl sm:text-2xl lg:text-xl leading-relaxed max-w-3xl">
            At WellAged Care, we are more than just a platform—we are a promise.
            A promise to seniors that they are valued and respected, to families
            ...
            <b>WellAged Care</b> aims to make a significant impact across
            Nigeria and Africa by{" "}
            <b>
        ...
        <div className="join-the-movement mt-6 py-2 border-b-4">
          <div className="text">
            <h2 className="heading text-3xl lg:text-4xl font-extrabold py-2 mt-3">
              Join the WellAged Care Movement
            </h2>
            <p className=" text-xl sm:text-2xl lg:text-xl leading-relaxed max-w-3xl">
              WellAged Care is a growing movement, and we can’t do it alone.
              Whether you're a family navigating the challenges of senior care,
              a passionate caregiver, or someone who believes in the dignity of
              aging, there is a place for you in the WellAged Care community. By
              choosing WellAged Care, you are not just opting for a service. You
              are taking a stand for a future where every elder receives the
              care they deserve, where families can support their loved ones
              from anywhere in the world, and where caregivers are valued as
              partners in improving the lives of seniors.
            </p>
          </div>
          {/* <Image /> */}
        </div>
